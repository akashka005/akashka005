...
██║  ██║██║  ██╗██║  ██║███████║██║  ██║    ██║  ██╗     ██║  ██║
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝    ╚═╝  ╚═╝    ╚═╝  ╚═╝
           AI / ML Engineer  ·  RAG  ·  Multi-Agent Systems
```
...
║      CGPA: 6.9                               Aug 2023 – May 2027    ║
╠══════════════════════════════════════════════════════════════════════╣
║  🏫  Excel Central School                      Tamil Nadu, India     ║
║      ISC Class XII: 81%  |  ICSE Class X: 96%                       ║
╚══════════════════════════════════════════════════════════════════════╝
```
...
```
  ● Mastering Generative AI and Generative AI Tools   │ Udemy          │ Sep 2025
  ● Basics of DSA using C++                           │ LPU            │ Nov 2025
  ● Unveiling Basic Python Towards AI/ML              │ CSE Pathshala  │ Mar 2024
  ● Beginning of C++ Programming                      │ Udemy          │ Feb 2024
```
...
**akashka688@gmail.com · +91-9600205581**
